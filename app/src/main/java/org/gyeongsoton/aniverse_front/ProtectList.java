...
public class ProtectList extends Fragment {
    ...
    /*
    public static SlideProtectFragment newInstance(int number){
        SlideProtectFragment protectFragment = new SlideProtectFragment();
            ...
            public void onResponse(String response) {
                try {
                    ...
                    if (success) {
                        ...
                        mList = new ArrayList<>();
                        //어댑터 객체
                        aniAdapter = new ListRecycleAdapter(2,mContext,mList);
                        //리사이클러뷰 객체
