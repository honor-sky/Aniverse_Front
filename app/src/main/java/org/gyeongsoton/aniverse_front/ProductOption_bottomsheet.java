...
public class ProductOption_bottomsheet extends BottomSheetDialogFragment {
    ...
    public View onCreateView(
        ...
        View view = (View)inflater.inflate(R.layout.bottomsheet_productoption, container, false);
        ...
        buy_btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(getActivity(), ProductBuy.class);
